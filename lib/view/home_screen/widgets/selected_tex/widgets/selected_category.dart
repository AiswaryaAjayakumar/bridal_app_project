                    ...
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => DetailedDress(
                              img: ImageConstants.detailsImage[index]["img"].toString(),
                              name: ImageConstants.detailsImage[index]["name"].toString(),
                              price: ImageConstants.detailsImage[index]
                                  ["price"],
                              des: ImageConstants.detailsImage[index]["des"].toString(),
                              left: ImageConstants.detailsImage[index]["left"].toString()),
                        ));
                  },
                  child: Container(
